...
from .views import HomeProductView,Login,Register,ProductDetailView,SearchProductView,Checkoutcart,CheckoutComplete,Contectus,CheckOutPayment,MyAccount,AboutUS,FAQ,ProductView,ProductShippingview
